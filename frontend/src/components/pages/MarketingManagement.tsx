...
import { Megaphone, Share2, Globe, Compass, PieChart, Users, ArrowLeft, Send, CheckCircle2 } from 'lucide-react';
...
const MarketingManagement = () => {
  ...
  const pillars = [
    { title: 'تحليل وتحديد السوق المستهدف', desc: 'دراسة دقيقة للمنافسين وتحديد الفئات المستهدفة وتسعير الغرف بمرونة وذكاء لمواكبة العرض والطلب.' },
    { title: 'زيادة حجم المبيعات المباشرة', desc: 'تفعيل وتطوير قنوات الحجز المباشر عبر الموقع الإلكتروني والاتصال لتقليص عمولات الوسطاء.' },
    { title: 'التسويق الرقمي الفعال', desc: 'إطلاق حملات إعلانية احترافية عبر منصات التواصل ومحركات البحث لزيادة الوعي بالعلامة التجارية.' },
    { title: 'إدارة القنوات والحجوزات (OTA)', desc: 'ربط المنشأة بكبرى قنوات الحجز العالمية (مثل Booking, Expedia, Airbnb) وإدارتها مركزياً وبشكل فوري.' },
    { title: 'العلاقات العامة وبناء الشراكات', desc: 'بناء شراكات استراتيجية مع شركات السياحة، منظمي الفعاليات، والشركات الكبرى لجذب الوفود السياحية.' },
    { title: 'حملات إعلانية وتنشيطية مبتكرة', desc: 'إعداد عروض موسمية وباقات حصرية متميزة تناسب الإجازات والأعياد لضمان أعلى معدلات الإشغال.' }
  ];
        ...
        >
          ...
          <div className="text-center mb-16 max-w-3xl mx-auto">
            <div className="inline-flex items-center justify-center p-3 bg-[#c9a55a]/10 rounded-2xl mb-4 border border-[#c9a55a]/20">
              <Megaphone className="w-10 h-10 text-[#c9a55a]" />
            </div>
            <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 tracking-tight mb-4">
              إدارة التسويق وتنشيط الإشغال
            </h1>
            <p className="text-xl text-[#8a6d2c] font-medium opacity-90 mb-6">
              استراتيجيات تسويقية مبتكرة تضمن حضوراً متميزاً وتدفقاً مستمراً للحجوزات
            </p>
          ...
          <div className="luxury-card rounded-[2.5rem] p-8 md:p-12 mb-16 relative overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto">
              <h2 className="text-2xl font-bold text-gray-900 mb-6 text-right border-r-4 border-[#c9a55a] pr-4">
                قوة التسويق الرقمي والمبيعات
              </h2>
              <p className="text-lg text-gray-700 leading-relaxed text-justify mb-6">
                في عالم اليوم الرقمي، لا يكفي تقديم خدمة فندقية ممتازة فقط بل يجب أن يعرف العالم بأسره عن تميزك. إن قسم التسويق في لامار بارك يعمل كقوة دافعة خلف زيادة معدلات الإشغال ورفع القيمة السوقية للمنشآت التي نديرها. نحن نصنع قصة جاذبة لعقارك عبر استراتيجيات تسويقية متعددة القنوات ومدروسة بدقة متناهية.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed text-justify">
                من خلال تفعيل أحدث تقنيات إدارة القنوات (Channel Management) والربط مع كبرى منصات السفر العالمية (OTAs)، نضمن إظهار غرفك وشاليهاتك لملايين السياح يومياً مع تحديث فوري وتلقائي للأسعار وتوافر الغرف لمنع الحجوزات المزدوجة. بالتوازي مع ذلك، نقوم بتدشين حملات تسويق رقمي مركزة تزيد من نسبة الحجز المباشر عبر موقعنا لتخفيض تكلفة العمولات وتحسين العوائد.
              </p>
            </div>
          </div>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="luxury-card rounded-[2.5rem] p-8 md:p-12 relative overflow-hidden border border-[#c9a55a]/30 shadow-2xl">
              ...
              <div className="text-center mb-8 relative z-10">
                <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-3">شراكة تسويقية وترويج لعقارك</h3>
                <p className="text-[#8a6d2c] font-medium text-sm md:text-base">
                  هل ترغب في مضاعفة مبيعاتك ورفع نسبة إشغال غرفك وفندقك؟ شريكك الاستراتيجي بانتظارك.
                </p>
              </div>
              ...
              {formSubmitted ? (
                <div className="text-center py-10 relative z-10 animate-fade-in">
                  ...
                  <p className="text-gray-600 mb-6">لقد استلمنا طلب التسجيل والترويج بنجاح. سيقوم مستشار التسويق الفندقي لدينا بالتواصل معك قريباً جداً.</p>
                  <button 
                ...
                <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                      <label className="block text-sm font-bold text-gray-700 mb-2">اسم العقار / الفندق</label>
                      <input 
                        type="text" 
                        value={formData.propertyName}
                        onChange={(e) => setFormData({...formData, propertyName: e.target.value})}
                        placeholder="مثال: أجنحة لامار الفندقية"
                        className="w-full bg-white/70 border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-[#c9a55a]/40 focus:border-[#c9a55a] transition"
                      />
                    </div>
                    <div>
                  ...
                  <div>
                    <label className="block text-sm font-bold text-gray-700 mb-2">موقع وعنوان العقار</label>
                    <input 
                      type="text" 
                      required
                  ...
                  <div>
                    <label className="block text-sm font-bold text-gray-700 mb-2">ما هي أهدافك التسويقية الحالية؟</label>
                    <textarea 
                      rows={4}
                      value={formData.message}
                      onChange={(e) => setFormData({...formData, message: e.target.value})}
                      placeholder="اكتب تطلعاتك التسويقية، أو أي تحديات تواجهها بخصوص قنوات البيع الحالية..."
