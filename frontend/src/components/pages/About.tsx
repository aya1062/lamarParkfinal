    ...
    <div className="min-h-screen bg-gray-50 pt-8">
      ...
      <div className="relative bg-gradient-to-r from-gold to-gold-light text-white py-20">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl max-w-3xl mx-auto leading-relaxed">
            لامار بارك هي منصة رائدة في مجال حجز الفنادق والشاليهات الفاخرة في المملكة العربية السعودية، 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-6 text-gray-700 leading-relaxed">
                <p>
                  بدأت رحلة لامار بارك في عام 2019 برؤية واضحة: تقديم أفضل تجربة حجز للفنادق والشاليهات 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              نستَرشد بمجموعة من القيم الأساسية التي تحدد هويتنا وتوجّه عملنا اليومي
            </p>
          </div>
      ...
      <div className="py-16 bg-gradient-to-r from-gold to-gold-light">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          <h2 className="text-4xl font-bold mb-6">انضم إلى عائلة لامار بارك</h2>
