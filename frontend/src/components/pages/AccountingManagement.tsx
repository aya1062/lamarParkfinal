...
import { Calculator, TrendingUp, FileText, DollarSign, Percent, ShieldCheck, ArrowLeft, Send, CheckCircle2 } from 'lucide-react';
...
const AccountingManagement = () => {
  ...
  const pillars = [
    { title: 'إعداد الميزانيات التقديرية', desc: 'تخطيط مالي دقيق وإعداد ميزانيات تشغيلية ورأسمالية تغطي كافة متطلبات المنشأة فصلياً وسنوياً.' },
    { title: 'إدارة وتخفيض التكاليف', desc: 'تحليل دقيق ومستمر لجميع مصاريف التشغيل للحد من الهدر المالي وتحسين هامش الربح الإجمالي.' },
    { title: 'التقارير المالية الدورية', desc: 'إصدار قوائم مالية، ميزانيات عمومية، وتقارير أرباح وخسائر شهرية وربع سنوية بشفافية متناهية.' },
    { title: 'الرقابة المالية والتدقيق', desc: 'تطبيق أنظمة حوكمة مالية صارمة على المداخيل والمشتريات والمدفوعات لمنع حدوث أي تجاوزات.' },
    { title: 'نظام المشتريات المركزي', desc: 'تفعيل دورة مشتريات متكاملة تضمن جودة التوريد والحصول على أفضل عروض الأسعار.' },
    { title: 'المدفوعات والتسويات الماليّة', desc: 'تنظيم سداد مستحقات الموردين، رواتب الموظفين، والتسويات البنكية اليومية بدقة وسلاسة.' }
  ];
        ...
        >
          ...
          <div className="text-center mb-16 max-w-3xl mx-auto">
            <div className="inline-flex items-center justify-center p-3 bg-[#c9a55a]/10 rounded-2xl mb-4 border border-[#c9a55a]/20">
              <Calculator className="w-10 h-10 text-[#c9a55a]" />
            </div>
            <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 tracking-tight mb-4">
              إدارة الحسابات والرقابة المالية
            </h1>
            <p className="text-xl text-[#8a6d2c] font-medium opacity-90 mb-6">
              حلول مالية دقيقة وشفافة تضمن أمان المداخيل وتدعم اتخاذ القرار الاستراتيجي
            </p>
          ...
          <div className="luxury-card rounded-[2.5rem] p-8 md:p-12 mb-16 relative overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto">
              <h2 className="text-2xl font-bold text-gray-900 mb-6 text-right border-r-4 border-[#c9a55a] pr-4">
                الحوكمة المالية والأمان النقدي
              </h2>
              <p className="text-lg text-gray-700 leading-relaxed text-justify mb-6">
                في قطاع الضيافة، تعد الإدارة المالية الدقيقة هي الركيزة الكبرى لاستمرارية النجاح ونمو الاستثمار. إننا في لامار بارك نقدم حلولاً مالية ومحاسبية متقدمة تدار بواسطة كوادر متخصصة وذات خبرة طويلة في المحاسبة الفندقية. نحن نضمن حماية وتدفق مداخيلك، ونفرض حوكمة تامة وشفافة على عمليات الدفع والتحصيل.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed text-justify">
                من خلال تزويدك بتقارير مالية وتفصيلية دورية للأرباح والخسائر وتحليل نسب الإشغال ومتوسط الدخل اليومي، نضع بين يديك رؤية رقمية واضحة تساعدك على اتخاذ القرارات التوسيعية والمالية بثقة تامة. نحن ندير ميزانيتك باحترافية تسعى دائماً لتقليص التكاليف المهدرة وتعظيم هوامش الأرباح الصافية لمشروعك.
              </p>
            </div>
          </div>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="luxury-card rounded-[2.5rem] p-8 md:p-12 relative overflow-hidden border border-[#c9a55a]/30 shadow-2xl">
              ...
              <div className="text-center mb-8 relative z-10">
                <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-3">استشارة وحلول مالية لعقارك</h3>
                <p className="text-[#8a6d2c] font-medium text-sm md:text-base">
                  هل ترغب في تحسين حسابات عقارك الفندقي وإدارته مالياً بشفافية تامة؟ تواصل معنا اليوم.
                </p>
              </div>
              ...
              {formSubmitted ? (
                <div className="text-center py-10 relative z-10 animate-fade-in">
                  ...
                  <p className="text-gray-600 mb-6">لقد تلقينا طلب الاستشارة المالية بنجاح. سيقوم مستشار الإدارة المالية لدينا بالتواصل معكم قريباً.</p>
                  <button 
                ...
                <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                      <label className="block text-sm font-bold text-gray-700 mb-2">اسم المنشأة الفندقية</label>
                      <input 
                        type="text" 
                        value={formData.propertyName}
                        onChange={(e) => setFormData({...formData, propertyName: e.target.value})}
                        placeholder="اسم الفندق أو المنتجعات"
                        className="w-full bg-white/70 border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-[#c9a55a]/40 focus:border-[#c9a55a] transition"
                      />
                    </div>
                    <div>
                  ...
                  <div>
                    <label className="block text-sm font-bold text-gray-700 mb-2">المدينة / الدولة</label>
                    <input 
                      type="text" 
                      required
                  ...
                  <div>
                    <label className="block text-sm font-bold text-gray-700 mb-2">هل لديك أي متطلبات خاصة بخصوص التدقيق أو الحوكمة المالية؟</label>
                    <textarea 
                      rows={4}
                      value={formData.message}
                      onChange={(e) => setFormData({...formData, message: e.target.value})}
                      placeholder="صف لنا الوضع المالي الحالي أو المشاكل المحاسبية التي تود حلها..."
