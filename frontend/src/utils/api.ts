...
export const API_URL: string = ENV?.VITE_API_URL || 'http://lamarparks.com/api';
...
export const PAYMENT_API_URL: string = ENV?.VITE_PAYMENT_API_URL || (isLocalHost ? 'http://lamarparks.com/api' : API_URL);
