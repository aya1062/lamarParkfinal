...
export const API_URL: string = ENV?.VITE_API_URL || 'https://lamarparks.com/api';
...
export const PAYMENT_API_URL: string = ENV?.VITE_PAYMENT_API_URL || (isLocalHost ? 'https://lamarparks.com/api' : API_URL);
